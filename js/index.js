...
function renderPrice() {
  ...
  // Select the price panel elements
  ...
  // Loop through each ingredient and check if it's selected
  for (let ingredient in ingredients) {
    if (state[ingredient]) {
      // Add the ingredient's price to the total price
      totalPrice += ingredients[ingredient].price;
      
      // Add the selected ingredient to the price list in the DOM
...
document.querySelector('.btn.btn-pepperoni').addEventListener('click', function () {
  ...
  renderEverything();
  renderButtons(); // Update button active class
  renderPrice(); //Update the price
});
